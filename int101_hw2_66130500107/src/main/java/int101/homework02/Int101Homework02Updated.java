...
public class Int101Homework02Updated {
    ...
    static void work01Utilitor() {
       ...
       1.5 Show in this "work01Utilitor" method how to 
        ...
        System.out.println(Utilitor.testString("Test testString : " + "Sipang"));
    ...
    static void work02Person() {
       ...
       2.11 Show in this "work02Person" method how to
        ...
        Person p3 = new Person("Josh", "Paul");
        Person p4 = new Person("Mark", "Mayson");
        System.out.println("Tesr toString p3 : " + p3);
        System.out.println("Tesr toString p4 : " + p4);
        System.out.println("Test getId p3 : " + p3.getId());
        System.out.println("Test getFirstname p3 : " + p3.getFirstname());
        System.out.println("Test getLastname p3 : " + p3.getLastname());
        p3.setFirstname("Daniel");
        System.out.println("Test setFirstname" + p3);
        p3.setLastname("Kang");
        System.out.println("Test setLastname" + p3);
        System.out.println("Test equals p3 == p4 : " + p3.equals(p4));
    ...
    static void work03Account() {
       ...
       3.13 Show in this "work03Account" method how to
        ...
        try {
            Person p1 = new Person("Ron", "Weasly");
            Account acc1 = new Account(p1);
            System.out.println("Test deposit :" + acc1.deposit(-1));
            Account acc2 = new Account(null);
        } catch (Exception e) {
        }
        Person p2 = new Person("Harry", "Potter");
        Person p3 = new Person("Hermione", "Granger");
        Account acc2 = new Account(p2);
        Account acc3 = new Account(p3);
        ...
        System.out.println("Test deposit 3000, balance :  " + acc2.deposit(3000));
        System.out.println("Test withdraw 1000, balance :  " + acc2.withdraw(1000));
        //Test transfer 1000 to acc2
        acc2.transfer(500, acc3);
        System.out.println("Test transfer 500 to acc2, balance acc2 : " + acc2.getBalance() + ", " + "balance acc3 : " + acc3.getBalance());
        System.out.println("Test toString acc2 : " + acc2);
        System.out.println("Test equals acc1 == acc2 : " + acc2.equals(p3));
